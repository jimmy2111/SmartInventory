...
<h3 class="mb-5">Product Tracker</h3>
<div class="mb-4">
...
<table border="1" class="table w-75 table-striped" style = "box-shadow: 0 3px 10px rgb(0 0 0 / 0.2); border: 2px solid black">
<thead class="table-success">
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=name&sortOrder=${revSortOrder}">Name</a></th>
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=description&sortOrder=${revSortOrder}">Description</a></th>
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=unitPrice&sortOrder=${revSortOrder}">Unit Price</a></th>
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=quantity&sortOrder=${revSortOrder}">Quantity</a></th>
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=thresholdQuantity&sortOrder=${revSortOrder}">Threshold Quantity</a></th>
<th class="text-center"><a href="?pageNo=${currentPage}&sortField=supplier.name&sortOrder=${revSortOrder}">Supplier Name</a></th>
</thead>
...
<td class="text-center">${p.thresholdQuantity}</td>
